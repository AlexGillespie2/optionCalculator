...
public class OptionCalculatorApplication extends Application {
	...
	Tab tab0 = new Tab();
        ...
        tab1.setContent(new OptionPositionCalculatorGUI(new putSpreadOptionPosition(new putOption(true, "SPCE", 21, "2/21/2020", 0.5), new putOption(false, "SPCE", 20, "2/21/2020", 0.25))));
